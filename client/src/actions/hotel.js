...
async () => await axios.get(`${process.env.REACT_APP_API}/hotels`)
...
export const searchListingsLocation = async (query) => 
await axios.post(`${process.env.REACT_APP_API}/search-listings-location`, query);
export const searchListingsTypes = async (query) => 
await axios.post(`${process.env.REACT_APP_API}/search-listings-types`, query);